...
public class AddServerJFrame extends javax.swing.JFrame {

    /**
     * Creates new form AddServerJFrame
     */
    Hotel hotel;
    int checkIn;
    public AddServerJFrame(Hotel h, int ci) {
        initComponents();
        this.hotel = h;
        this.checkIn = ci;
        populateServer();
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(63, 63, 63)
                        .addComponent(selectServer, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(166, 166, 166)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(add)
    ...
    private void addMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addMouseClicked
        ...
        status = PresidentialServing.assignServer(checkIn, staff.getStaffID());
        if(status){
...
//            java.util.logging.Logger.getLogger(AddServerJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new AddServerJFrame(hotel,checkIn).setVisible(true);
//            }
//        });
//    }
    ...
    private javax.swing.JComboBox<Staff> selectServer;
