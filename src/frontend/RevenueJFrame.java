...
import static frontend.CheckInDateRangeJFrame.buildTableModel;
...
public class RevenueJFrame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form RevenueJFrame
     */
    Date startDate;
    Date endDate;
    public RevenueJFrame(Date startDate, Date endDate) {
        this.startDate = startDate;
        this.endDate = endDate;
        initComponents();
        try{
            jTable1.setModel(buildTableModel(Report.getRevenue(startDate, endDate)));
